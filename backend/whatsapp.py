...
class WhatsAppWebClient:
    ...
    def sendTextMessage(self, number, text, epoch):
        ...
        msgData = ["action", {"type": "relay", "epoch": str(epoch)},[["message", None, WAWebMessageInfo.encode(messageParams)]]]
        print(msgData)
